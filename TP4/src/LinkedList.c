...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if (this != NULL && nodeIndex <= ll_len(this) && nodeIndex >= 0)
    {
    	...
    	{
    		pNodeNext = getNode(this, nodeIndex);
    		pNodeBack = getNode(this, nodeIndex-1);
    		pNode->pNextNode = pNodeNext;
    		pNodeBack->pNextNode = pNode;
    		returnAux = 0;
    	}
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if (this != NULL && index >= 0 && index < ll_len(this))
    {
    	...
    	if (pNode != NULL)
    	{
			if (index > 0)
			{
				pNodeBack = getNode(this, index-1);
		    	if (pNodeBack != NULL)
		    	{
		    		pNodeBack->pNextNode = pNode->pNextNode;
		    	}
			}
			else
			{
 ...
 * @brief cuenta la cantidad de elementos segun el criterio de la funcion que recibe
 *
 * @param this puntreo a la lista.
 * @param fn puntero a la funcion criterio
 * @return [-1]si la LL o la funcion son NULL. sino devuelve el resultado del conteo.
 */
int ll_count(LinkedList* this, int (*fn)(void* element))
{
	...
	if (this != NULL && fn != NULL)
	{
		for (i=0; i<ll_len(this); i++)
		{
			...
			acumulador = acumulador + fn(pElement);
		}
...
LinkedList* ll_filter(LinkedList* this, int (*fn)(void* element))
{
	...
	if (this != NULL && fn != NULL)
	{
		...
		for(i=0; i<ll_len(this) ;i++)
		{
			...
			if (fn(pElement) > 0)
			{
				ll_add(CloneLinkedList,pElement);
			}
		}
	}
